...
<layout:extends name="base">
    ...
    <layout:put block="body">
        <body>
          <h1>회원가입</h1>
          <form id="signup-form" role="form" action="${ctx}/auth/signup" method="post">
            <div class="form-group">
              <label for="emailAddress">이메일</label>
              <input type="email" class="form-control" id="emailAddress" name="emailAddress" placeholder="이메일 형식으로 입력하세요." />
            </div>
            <div class="form-group">
